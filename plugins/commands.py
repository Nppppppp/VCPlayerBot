...
async def start(client, message):
    ...
    buttons = [
        [
            InlineKeyboardButton('⚙️ Update Channel', url='https://t.me/SL_Tech_World'),
            InlineKeyboardButton('🧩 Source', url='https://github.com/maxsupun')
        ],
        [
...
async def repo_(client, message):
    buttons = [
        [
            InlineKeyboardButton('🧩 Repository', url='https://github.com/maxsupun'),
            InlineKeyboardButton('⚙️ Update Channel', url='https://t.me/SL_Tech_World'),     
        ],
        [
